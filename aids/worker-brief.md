...
**NEVER:** merge to `main`; push a release tag; touch files outside your task; edit another worker's branch; weaken, skip, or delete the done-check to make it pass; claim done without evidence; merge because CI is unavailable, or offer your own local test run as a substitute for it — your done-check evidence is a claim for the reviewer to verify, never merge check 2; work around an absent CI on your own.
