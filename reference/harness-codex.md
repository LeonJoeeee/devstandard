...
Use the temporary `core.md` compatibility artifact and self-contained `reference/orchestrator.md`
in a main Codex session. The orchestrator page governs. This page
...
Trusted SessionStart hooks deliver core, the orchestrator role and this adapter. After resuming an
older session, read any missing role artifact in full. If hooks are disabled or awaiting trust,
