...
4. **Add `.github/devstandard-guards.json`** from the template in `reference/hard-edges.md`, with
   the human's login and that issue number filled in, and push it to main. This is the last direct
   push the guard admits.
