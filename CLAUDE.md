...
- core.md token budget (hard ceiling 3000): `python3 -c "print(int(len(open('core.md').read().split())*1.35))"`
...
- Check the core.md token count BEFORE pushing any core.md edit — the ceiling is hard, CI fails at 3001.
