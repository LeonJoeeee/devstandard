# The Workflow tool's description — verbatim

> Transcribed 2026-06-11 from the tool definition as injected into the model's context (Claude Code v2.1.170 era). This is the "authoring textbook" the model sees every session. Canonical source: the Claude Code binary itself.
