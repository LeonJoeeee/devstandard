...
needs a fresh read-only reviewer. A Codex host uses the process binding in
`reference/harness-codex.md` for governed lanes. Read `reference/external-agent.md` for routing, reviewer
