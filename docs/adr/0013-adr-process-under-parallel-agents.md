...
**Amendment (2026-08-13, see 0031):** in the 2026-08-04 amendment above, "`howto/adr.md` carries
the operative wording" now reads `reference/adr.md`; `howto/` was merged into `reference/`. The
wording it names is unchanged. The two earlier mentions of `howto/adr.md`, in Context and
Consequences, record what this change touched and are left as written.
