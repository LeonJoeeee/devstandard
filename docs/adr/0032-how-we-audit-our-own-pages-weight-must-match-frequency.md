...
sites at once; that choice is retained where it was argued and priced where it was not). Amended by 0043 (2026-08-31), 0053 (2026-09-10).
...
**Amendment (2026-09-10, see 0053):** there are now four. ADR 0053 records the fourth — before a
...
rule differs from 1–3 in one way this ADR's framing does not cover: it also ships. 0053 states the
