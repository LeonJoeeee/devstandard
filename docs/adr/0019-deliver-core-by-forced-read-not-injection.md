...
**Amendment (2026-08-26, see 0038):** the SessionStart hook this ADR decided now *branches by
harness*: under Claude Code its behavior — the forced read of core.md described here — is
