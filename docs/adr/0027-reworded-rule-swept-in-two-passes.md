...
reconciled (0024's amendment is the worked case).

**Amendment (2026-08-06, see 0030):** the rule this ADR decides is **withdrawn from the shipped
method** and kept as repo practice in this repository's root `CLAUDE.md`. The reasoning above
