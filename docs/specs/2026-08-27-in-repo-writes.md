...
rather than merely containing the word; **whether any open issue reserves ADR number `0042` or
`0043`, which a text search cannot tell from citing them**; and whether the final check-1 verdict
blocks, which
