...
└── reference/                   # one file per thing core.md points at; read only when it does:
    ...
    ├── external-agent.md        #   dispatching to another vendor's agent (0036); when a subagent, when Codex; the standing setting (0040)
