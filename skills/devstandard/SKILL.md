...
For a main session, read [the orchestrator role](../../reference/orchestrator.md) in full unless
already delivered by SessionStart — it carries the shared workflow as well as the event loop.
Follow it within the user's requested scope and permissions.
